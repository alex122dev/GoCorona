(() => {
    ...
    da.init();
    document.addEventListener("scroll", headerClass);
    document.querySelector(".icon-menu").addEventListener("click", burger);
    document.addEventListener("click", videoPlay);
    function headerClass() {
        const header = document.querySelector("header");
        if (pageYOffset > 0 && !header.classList.contains("header__scroll")) header.classList.add("header__scroll");
        if (0 === pageYOffset && header.classList.contains("header__scroll")) header.classList.remove("header__scroll");
    }
    function burger() {
    ...
    function videoPlay(e) {
        ...
        let video = document.querySelector(".experts__item");
        let button = document.querySelector(".experts__video-button");
        if (targetElement.closest(".experts__video-button")) {
            video.play();
